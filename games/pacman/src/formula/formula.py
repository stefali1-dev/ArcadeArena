...
# Add music
pygame.mixer.init()
pygame.mixer.music.load('D:/ArcadeArena/games/pacman/src/pacman.mp3')
...
def startGame():
    ...
    Pacman = Player(w, pacman_height, "D:/ArcadeArena/games/pacman/src/images/pacman.png")
    all_sprites_list.add(Pacman)
    pacman_collide.add(Pacman)
    Blinky = Ghost(w, blinky_height, "D:/ArcadeArena/games/pacman/src/images/Blinky.png")
    monsta_list.add(Blinky)
    all_sprites_list.add(Blinky)
    Pinky = Ghost(w, monster_height, "D:/ArcadeArena/games/pacman/src/images/Pinky.png")
    monsta_list.add(Pinky)
    all_sprites_list.add(Pinky)
    Inky = Ghost(inky_width, monster_height, "D:/ArcadeArena/games/pacman/src/images/Inky.png")
    monsta_list.add(Inky)
    all_sprites_list.add(Inky)
    Clyde = Ghost(clyde_width, monster_height, "D:/ArcadeArena/games/pacman/src/images/Clyde.png")
